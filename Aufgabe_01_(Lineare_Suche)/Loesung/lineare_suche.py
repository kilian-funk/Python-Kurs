...
a)  Beschreibe in wenigen Sätzen, wie du in einer (großen) Menge an
...
d)  Ermittle für die Suche eines beliebigen Elements aus einer zufällig
    befüllte Liste die durchschnittliche Anzahl an Such-Iterationen. Führe
